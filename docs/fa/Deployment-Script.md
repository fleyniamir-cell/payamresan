...
| اجازه ایجاد حساب از طریق وب‌سایت | `SIGN_UP` | `true` |
| فعال‌کردن آپلود فایل | `FILE_UPLOAD` | `true` |
| حداکثر اندازه کل آپلود (مگابایت) | `FILE_UPLOAD_MAX_TOTAL_SIZE_MB` | `75` |
| فاصله زمانی حذف خودکار فایل (روز) | `MESSAGE_FILE_RETENTION` | `7` |
| حذف خودکار پیام‌های فقط‌متنی (روز) | `MESSAGE_TEXT_RETENTION` | `0` |
...
## mirrorها برای شبکه‌های محدودشده {#mirrors-for-restricted-networks}
